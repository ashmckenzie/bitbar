...
api_key = '7c3194d346a58c092b3307d5f5ba9d5c' # get yours at https://developer.forecast.io
units = 'si' # change to si for metric, default is imperial

def auto_loc_lookup():
  try:
    return json.load(urllib2.urlopen('http://ipinfo.io/220.253.116.57/json'))
